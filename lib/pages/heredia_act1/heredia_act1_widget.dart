...
import 'heredia_act1_model.dart';
export 'heredia_act1_model.dart';

class HerediaAct1Widget extends StatefulWidget {
  const HerediaAct1Widget({super.key});

  @override
  State<HerediaAct1Widget> createState() => _HerediaAct1WidgetState();
}

class _HerediaAct1WidgetState extends State<HerediaAct1Widget>
    with TickerProviderStateMixin {
  late HerediaAct1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HerediaAct1Model());
