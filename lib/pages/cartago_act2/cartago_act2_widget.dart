...
import 'cartago_act2_model.dart';
export 'cartago_act2_model.dart';

class CartagoAct2Widget extends StatefulWidget {
  const CartagoAct2Widget({super.key});

  @override
  State<CartagoAct2Widget> createState() => _CartagoAct2WidgetState();
}

class _CartagoAct2WidgetState extends State<CartagoAct2Widget>
    with TickerProviderStateMixin {
  late CartagoAct2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartagoAct2Model());
