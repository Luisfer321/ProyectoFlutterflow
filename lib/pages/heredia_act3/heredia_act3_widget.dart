...
import 'heredia_act3_model.dart';
export 'heredia_act3_model.dart';

class HerediaAct3Widget extends StatefulWidget {
  const HerediaAct3Widget({super.key});

  @override
  State<HerediaAct3Widget> createState() => _HerediaAct3WidgetState();
}

class _HerediaAct3WidgetState extends State<HerediaAct3Widget>
    with TickerProviderStateMixin {
  late HerediaAct3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HerediaAct3Model());
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 20.0, 20.0),
                            child: Text(
                              'It is located less than 7km from downtown San Rafael de Heredia and less than 5km from Monte de la Cruz. It is important to note that it is only open from Friday to Sunday from 8:00 a.m. to 4:00 p.m. to the public.\n\nHere you have the possibility to enjoy: green areas, ranches equipped with grill, trails, cycling circuit, soccer field, children\'s park with games, outdoor gym and it is pet friendly. ',
