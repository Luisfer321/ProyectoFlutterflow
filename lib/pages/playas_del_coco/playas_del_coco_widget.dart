...
import 'playas_del_coco_model.dart';
export 'playas_del_coco_model.dart';

class PlayasDelCocoWidget extends StatefulWidget {
  const PlayasDelCocoWidget({super.key});

  @override
  State<PlayasDelCocoWidget> createState() => _PlayasDelCocoWidgetState();
}

class _PlayasDelCocoWidgetState extends State<PlayasDelCocoWidget>
    with TickerProviderStateMixin {
  late PlayasDelCocoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayasDelCocoModel());
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 0.0, 20.0),
                            child: Text(
                              'Playas del Coco is a lively beach town in Guanacaste, Costa Rica, known for its beautiful sunsets and clear waters. Located near the Papagayo Gulf, it offers great opportunities for snorkeling, fishing, and enjoying local restaurants, making it a popular spot for both relaxation and adventure.',
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                'https://images.visitarcostarica.com/playa-del-coco-costa-rica.jpg',
                                width: 306.0,
                                height: 223.0,
                                fit: BoxFit.cover,
                              ),
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      'https://www.dresseldivers.com/wp-content/uploads/Difference-between-Snorkeling-and-Scuba-Diving-1.jpg',
                                      width: 200.0,
                                      height: 88.0,
                                      fit: BoxFit.cover,
                                    ),
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.network(
                                        'https://selvatura.com/wp-content/uploads/2018/10/Selvatura-Park-Canopy-Tour-4.jpg',
                                        width: 215.0,
                                        height: 96.0,
                                        fit: BoxFit.cover,
                                      ),
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.asset(
                                        'assets/images/jungle-night-tour-18.jpg',
                                        width: 211.0,
                                        height: 88.0,
                                        fit: BoxFit.cover,
                                      ),
