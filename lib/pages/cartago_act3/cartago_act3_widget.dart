...
import 'cartago_act3_model.dart';
export 'cartago_act3_model.dart';

class CartagoAct3Widget extends StatefulWidget {
  const CartagoAct3Widget({super.key});

  @override
  State<CartagoAct3Widget> createState() => _CartagoAct3WidgetState();
}

class _CartagoAct3WidgetState extends State<CartagoAct3Widget>
    with TickerProviderStateMixin {
  late CartagoAct3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartagoAct3Model());
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 20.0, 20.0),
                            child: Text(
                              'Irazú Volcano is an active shield volcano2 located in Costa Rica, in the Central Volcanic Range, within the national park that bears its name, about 32 km north of the city of Cartago. Its summit, at an altitude of 3432 m a.s.l., making it the highest volcano in Costa Rica, is located in the district of Santa Rosa, in the Canton of Oreamuno, Province of Cartago.',
