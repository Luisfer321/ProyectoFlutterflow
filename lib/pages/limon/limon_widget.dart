...
import 'limon_model.dart';
export 'limon_model.dart';

class LimonWidget extends StatefulWidget {
  const LimonWidget({super.key});

  @override
  State<LimonWidget> createState() => _LimonWidgetState();
}

class _LimonWidgetState extends State<LimonWidget>
    with TickerProviderStateMixin {
  late LimonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LimonModel());
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 0.0, 20.0),
                            child: Text(
                              'Limón is a province of Costa Rica, in the easternmost part of the country. It is bordered to the north by the Republic of Nicaragua, to the northeast by the Caribbean Sea, to the west by Heredia, Cartago and San José, to the southwest by Puntarenas and to the southeast by Panama.',
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.asset(
                                      'assets/images/rice-and-beans_web.jpg',
                                      width: 200.0,
                                      height: 88.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              Align(
                                alignment: const AlignmentDirectional(-0.65, 0.88),
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      10.0, 0.0, 0.0, 10.0),
                                  child: Text(
                          ...
                          child: Padding(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Align(
                                  alignment: const AlignmentDirectional(-0.4, 0.87),
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        5.0, 0.0, 0.0, 10.0),
                                    child: Text(
