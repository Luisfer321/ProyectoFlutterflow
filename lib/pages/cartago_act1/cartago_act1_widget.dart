...
import 'cartago_act1_model.dart';
export 'cartago_act1_model.dart';

class CartagoAct1Widget extends StatefulWidget {
  const CartagoAct1Widget({super.key});

  @override
  State<CartagoAct1Widget> createState() => _CartagoAct1WidgetState();
}

class _CartagoAct1WidgetState extends State<CartagoAct1Widget>
    with TickerProviderStateMixin {
  late CartagoAct1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartagoAct1Model());
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 20.0, 20.0),
                            child: Text(
                              'The Durán Sanatorium is a ruin of an old hospital in Costa Rica and a ghost hotel. It is also a recreational park today and was previously a sanatorium created to house and treat patients suffering from tuberculosis. It had all the characteristics of a first-world hospital capable of housing around 300 patients in the province of Cartago, Costa Rica. It is located in the Potrero Cerrado district of Oreamuno.',
                            ...
                            child: InkWell(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment: const AlignmentDirectional(-0.81, 0.9),
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          10.0, 0.0, 0.0, 10.0),
                                      child: Text(
                            ...
                            child: InkWell(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.32, 0.89),
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          5.0, 0.0, 0.0, 10.0),
                                      child: Text(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://media-cdn.tripadvisor.com/media/photo-s/0a/ff/a6/f7/restaurant-mi-tierra.jpg',
                                      width: 200.0,
                                      height: 88.0,
                                      fit: BoxFit.cover,
                                    ),
