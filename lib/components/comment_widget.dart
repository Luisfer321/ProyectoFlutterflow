...
class _CommentWidgetState extends State<CommentWidget> {
  ...
  void initState() {
    ...
    _model.textController ??=
        TextEditingController(text: 'Ingrese su comentario ');
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: StreamBuilder<ActividadesRecord>(
          stream: ActividadesRecord.getDocument(widget.actividad!),
            ...
            return Container(
              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-0.86, -0.48),
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-1.09, 0.18),
                    child: Padding(
                      padding:
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-0.15, 0.89),
                    child: FFButtonWidget(
                      onPressed: () async {
                        await CommentRecord.createDoc(widget.actividad!)
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Su opinión fue agregada correctamente ',
                              style: TextStyle(
